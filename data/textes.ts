...
export const textesParDefaut = {
  ...
  apropos: {
    ...
    pageTexte2:
      "Ce que je fais : du FPS compétitif, des soirées jeux d'horreur entre ami·es, des sessions plus tranquilles, et beaucoup d'échanges avec la communauté. Ce que je ne fais pas : du contenu formaté à l'excès. Je préfère que ça reste vivant.",
    pageTexte3:
